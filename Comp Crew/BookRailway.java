...
public class BookRailway
{
	...
	static JFrame frame;
	BookRailway(String from,String to,String date,String res,int key,double price)
	{
		frame = new JFrame();
	    ...
	    pay.setBounds(31, 473, 202, 26);
	    frame.getContentPane().add(pay);
	    
	    JLabel lblNewLabel_2 = new JLabel("Block - A");
	    lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblNewLabel_2.setForeground(new Color(0, 0, 0));
	    lblNewLabel_2.setBackground(new Color(240, 240, 240));
	    lblNewLabel_2.setBounds(185, 258, 70, 13);
	    frame.getContentPane().add(lblNewLabel_2);
	    
	    JLabel lblNewLabel_2_1 = new JLabel("Block - B");
	    lblNewLabel_2_1.setForeground(Color.BLACK);
	    lblNewLabel_2_1.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblNewLabel_2_1.setBackground(SystemColor.menu);
	    lblNewLabel_2_1.setBounds(346, 260, 70, 13);
	    frame.getContentPane().add(lblNewLabel_2_1);
	    
	    JLabel lblNewLabel_2_2 = new JLabel("Block - C");
	    lblNewLabel_2_2.setForeground(Color.BLACK);
	    lblNewLabel_2_2.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblNewLabel_2_2.setBackground(SystemColor.menu);
	    lblNewLabel_2_2.setBounds(507, 260, 70, 13);
	    ...
	    noselection.setBounds(31, 509, 304, 30);
	    frame.getContentPane().add(noselection);
	    
	    
	    
	    frame.setSize(718,586);
